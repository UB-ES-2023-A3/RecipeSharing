...
def add_rating_logic(request):
    ...
    if user_id in recipe.rating_list:
       ...
       recipe.rating_average = (((recipe.rating_average * recipe.rating_amount) - previous_rating) + rating) / recipe.rating_amount
...
def get_rating_by_id(recipe_id):
    try:
        ...
        return {'rating_amount':recipe.rating_amount, 'rating_average':recipe.rating_average}  # Supongo que tienes un método toJson() en tu modelo Recipe para convertirlo en un diccionario.
