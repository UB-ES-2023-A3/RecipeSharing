  ...
  <div>
    <div class="mainContainer">
      ...
      <div class="secondaryContainer">
        ...
        <AppTextField
      :defaultMessage="defaultMessageName"
      @update:textValue="textFieldName = $event"
    />
      </div>
      <div class="secondaryContainer">
        <div class="subtitleContainer">
        ...
        <AppFoodMultiSelect :optionGroups="foodLists" :buttonTitle="IngredientButton" :notesTitle="IngredientNotes" />
      </div>
      <div class="secondaryContainer">
        <div class="subtitleContainer">
          <div class="subTitle">
      ...
      <div class="secondaryContainer">
        ...
        <AppFoodMultiSelect :optionGroups="AllergensLists" :buttonTitle="AllergensButton" :notesTitle="AllergensNotes"/>
      </div>
      <div>
...
<script>
import AppFoodMultiSelect from "@/components/AppFoodMultiSelect.vue";
...
export default {
  ...
  data() {
    return {
      textFieldName: "holaaaaa", // Variable para almacenar el valor del campo de texto
